...
DEBUG = True
SECRET_KEY = "73d59b44866f62f36f2ccdf458bff7f880912c6c"

app = Flask(__name__)
# app.config["SECRET_KEY"] = "ffffffffgfdklvjlnjvsdkhkncjdasldjxkmjdsi"
...
def login():
    ...
    elif request.method == "POST" and request.form["username"] == "admin" and request.form["psw"] == "1":
        session["userLogged"] = request.form["username"]
        return redirect(url_for('profile', username=session["userLogged"]))
    return render_template("login.html", title="Страница авторизации", menu=menu)
